...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.65\textwidth]{act_selection/pipeline.png}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.99\textwidth]{act_selection/pipeline_example.png}
...
% \begin{table*}[ht]
% \caption{Detailed results of the ablation study for the Answer Candidate Type (ACT) Selection framework. The table reports Hits@1 scores.}

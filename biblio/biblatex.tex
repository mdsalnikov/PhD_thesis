...
maxbibnames=99,% печатать полный список авторов в библиографии (без et al.)
...
\makeatother
% Печатаем ПОЛНЫЙ список авторов после названия (а не одного с [et al.])
\makeatletter
\renewbibmacro*{byauthor}{%
  \ifnameundef{author}{}{
    \begingroup
      \setcounter{minnames}{999}% печатать всех авторов
      \setcounter{maxnames}{999}% без сокращения до et al.
      \printnames{author}% полный список авторов
    \endgroup}}
% Некоторые драйверы biblatex-gost используют byauthor+others после названия
% Переопределяем его, чтобы не сокращать список до «[et al.]»
\renewbibmacro*{byauthor+others}{\usebibmacro{byauthor}}
\makeatother

...
\newcommand{\thesisAuthorOtherNames}{Михаил Дмитриевич}
\newcommand{\thesisAuthorInitials}{М. Д.}
\newcommand{\thesisAuthorLastNameEn}{Salnikov}
\newcommand{\thesisAuthorOtherNamesEn}{Mikhail Dmitrievich}
\newcommand{\thesisAuthorInitialsEn}{M. D.}
...
{Надежные вопросно ответные системы с выравниванием знаний по графу знаний}
\newcommand{\thesisTitleEn}              % Диссертация, название
{Trustworthy Question Answering system with Knowledge Graphs alignment}
...
{доктор компьютерных наук (физико-математические науки)}
...
{Panchenko Alexander Ivanovich}
\newcommand{\supervisorRegaliaEn}          % Научный руководитель, регалии
{Doctor of Computer Sciences (Physical and Mathematical Sciences)}
...
{«1» Ноября 2025 года в 12 часов 30 минут}
\newcommand{\defenseDateEn}              % Защита, дата
{November 1, 2025, at 12:30 p.m.}
